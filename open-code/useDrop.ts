...
type Target = (() => HTMLElement | Document | Window | null) | HTMLElement | Document | Window | null

function getTargetElement(target: Target) {
  if (!target) {
    return undefined;
  }
...
const useDrop = (target: Target, options: DropOptions = {}) => {
