...
- [ ] **Hook Migration (Repeat for Each Hook)**
  ...
  - [ ] **Index Update:** Add an export statement for the new hook in `src/index.ts`. (export must like this in index.ts  export {default as useDeviceMotion} from "./hooks/useDeviceMotion";)
