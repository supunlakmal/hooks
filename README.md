...
| [**`useErrorBoundary`**](https://github.com/supunlakmal/hooks/blob/main/docs/useErrorBoundary.md)               | Provides state management and control functions for React Error Boundaries.                                           |
...
| [**`useIdleTimer`**](https://github.com/supunlakmal/hooks/blob/main/docs/useIdleTimer.md)                       | Monitors user activity and triggers callbacks when the user becomes idle or active again.                             |
...
| [**`useIsMobile`**](https://github.com/supunlakmal/hooks/blob/main/docs/useIsMobile.md)                         | Detects if the current viewport is mobile-sized based on a configurable breakpoint.                                   |
...
| [**`useSwipeable`**](https://github.com/supunlakmal/hooks/blob/main/docs/useSwipeable.md)                         | Detects swipe gestures and add callback functions for it.                      |
| [**`useStepper`**](https://github.com/supunlakmal/hooks/blob/main/docs/useStepper.md)                           | Manages state and navigation logic for multi-step processes (wizards, forms).                                         |
