...
| [**`useWhyDidYouUpdate`**](https://github.com/supunlakmal/hooks/blob/main/docs/useWhyDidYouUpdate.md)           | Development utility to debug component re-renders by logging changed props. | [**`useIdleTimer`**](https://github.com/supunlakmal/hooks/blob/main/docs/useIdleTimer.md)               | Monitors user activity and triggers callbacks based on idle/active status.                                            |
